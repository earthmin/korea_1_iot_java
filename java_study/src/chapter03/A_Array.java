...
// - 데이터를 연속적으로 저장
// - 순서가 있음 (index 인덱스번호, 0부터 1씩 증가되는 값)
// - 중복도 가능 
public class A_Array {

	public static void main(String[] args) {
		/* 배열 VS 변수 
		 * 배열은 '생성한다' >> new 키워드 즉 연산자를 사용
		 * 변수는 '선언한다'
		 */
//		1) 변수
		int korean = 90;
...
//		2) 배열
//		:생성하여 사용하고 new 연산자를 사용한다.
		
//		=== 배열의 선언 ===
//		: 생성한 배열을 담을 그릇 
//		>> 데이터타입[] 배열명;
//		>> 데이터타입 배열명[]; 위에랑 아무런 차이 없음 똑같다 대체적으로 위에를 쓴다 ㅇㅇ 
		...
		// >> new 데이터타입[배열의 길이];
		array =	new int[3];
		System.out.println(array); // [I@28f67ac7 
		
		// === 배열의 요소에 접근 ===
		// 배열명[인덱스번호] = 데이터;
		// +) 데이터 변경(삽입): 배열명[인덱스번호] = 데이터;
		
		// cf) 배열 생성시 모든 요소는 모든 데이터타입의 기본값으로 초기화 
		// 숫자(0), 문자열(''), 논리형(false) 값이 들어간다 
		array[0] = 123;
...
//		System.out.println(array[3]); - Error
		...
		// a. 데이터타입[] 배열명 = new 데이터타입[] {요소1, 요소2, 요소3, 요소4}
		int[] scoreList = new int[] {90, 75, 100};
		System.out.println(scoreList[0]);
		
		// b. 데이터타입[] 배열명 =  {요소1, 요소2, 요소3, 요소4}

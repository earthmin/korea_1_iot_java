...
public class A_Variable {
	...
	public static void main(String[] args) {
		// 변수 (Variable)
		// : 데이터를 저장할 수 있는 메모기 '공간'
		
		// 1. 변수 선언: 메모리 공간을 생성한다
		
		// - 변수 선언 방법 (그릇 생성)
		// : 데이터타입 변수명;
		
		// - 변수 초기화 방법 (그릇에 데이터 넣기)
		// : 변수명 = 데이터값; (우항에서 좌항으로 대입한다 넣는다 라는 뜻이다냥)
		...
		// - 숫자로 시작 할 수 없다 (숫자로는 시작할 수 없다)
		// - 기호 _(언더스코어), $(달러)만 가능 (기호로 시작할수 있다 )
		// - lowerCamelCase를 사용 
